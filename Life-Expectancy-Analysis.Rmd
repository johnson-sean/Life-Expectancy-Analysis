...
```{r}
life_expec <- life_expec %>% select(country,year,life_expectancy,population,alcohol,hiv_aids,thin_5to9_years,thin_10to19_years,hepatitis_b,measles,polio,diphtheria,bmi,under_five_deaths,total_expenditure,gdp,percentage_expenditure,schooling,status)
```
...
> Devevloping is equal to 1 and developed is equal 0. This will be usefull for exploratory data analysis.
Also, if there is time, I can use with decision tree analysis like randomForest.
...
ggplot(data = le_adj, aes(x = life_expectancy))+
  ...
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Life Expectancy", y = "Count")

ggplot(data = le_adj, aes(x = alcohol))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Alcohol", y = "Count")

ggplot(data = le_adj, aes(x = hiv_aids))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 2, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 2, fill="#00BFC4", alpha = .35)+ labs(x = "HIV Aids", y = "Count")

ggplot(data = le_adj, aes(x = thin_5to9_years))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Thinness 5 to 9 years of age", y = "Count")

ggplot(data = le_adj, aes(x = thin_10to19_years))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Thinness 10 to 19 years of age", y = "Count")

ggplot(data = le_adj, aes(x = bmi))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "BMI", y = "Count")

ggplot(data = le_adj, aes(x = under_five_deaths))+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 500, fill="#00BFC4", alpha = .35)+ labs(x = "Developing Countries \n Under five years of age deaths", y = "Count")
ggplot(data = le_adj, aes(x = under_five_deaths))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
...
ggplot(data = le_adj, aes(x = hepatitis_b))+
  ...
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Hepatitis B", y = "Count")

ggplot(data = le_adj, aes(x = measles))+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 20000, fill="#00BFC4", alpha = .35)+ labs(x = "Developing Countries \n Measles", y = "Count")
ggplot(data = le_adj, aes(x = measles))+
...
ggplot(data = le_adj, aes(x = polio))+
  ...
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 2, fill="#00BFC4", alpha = .35)+ labs(x = "Polio", y = "Count")

ggplot(data = le_adj, aes(x = diphtheria))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 2, fill="#F8766D", alpha = 1)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 2, fill="#00BFC4", alpha = .35)+ labs(x = "Diphtheria", y = "Count")

ggplot(data = le_adj, aes(x = total_expenditure))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Total Expenditure", y = "Count")

ggplot(data = le_adj, aes(x = gdp))+
  #geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 5000, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 5000, fill="#00BFC4", alpha = .35)+ labs(x = "Developing Countries \n GDP", y = "Count")
ggplot(data = le_adj, aes(x = gdp))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 10000, fill="#F8766D", alpha = .7)+
...
ggplot(data = le_adj, aes(x = percentage_expenditure))+
  ...
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1000, fill="#00BFC4", alpha = .35)+ labs(x = "Percentage Expenditure", y = "Count")

ggplot(data = le_adj, aes(x = schooling))+
  geom_histogram(data = subset(le_adj, stat_num == 0), binwidth = 1, fill="#F8766D", alpha = .7)+
  geom_histogram(data = subset(le_adj, stat_num == 1), binwidth = 1, fill="#00BFC4", alpha = .35)+ labs(x = "Schooling", y = "Count")
```
...
ggplot(data = le_adj, aes(x = life_expectancy))+
  ...
  geom_vline(aes(xintercept=65.8),color="blue", linetype="dashed", size=.75)+ labs(x = "Life Expectancy", y = "Count", title = "Life expectancy histogram based on country status")
...
ggplot(data = le_adj, aes(x = life_expectancy, y = percentage_expenditure, color= status, size=population))+
...
_removing indicator and categorical variables under different handles_
```{r}
...
```
 _Finding number of components_
